...
class ExperimentManager:
    ...
    def __init__(
        ...
        # Use save_path as default tensorboard log path if not specified
        self.tensorboard_log = os.path.join(tensorboard_log, self.env_name) if tensorboard_log != "" else self.save_path
